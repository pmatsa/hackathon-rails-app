                            ...
                            <tr data-entry-id="{{ $maintenanceEvent->id }}">
                                ...
                                <td>
                                    @can('maintenance_event_show')
                                        <a class="btn btn-xs btn-primary" href="{{ route('admin.maintenance-events.show', $maintenanceEvent->id) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan

                                    @can('maintenance_event_edit')
                                        <a class="btn btn-xs btn-info" href="{{ route('admin.maintenance-events.edit', $maintenanceEvent->id) }}">
                                            {{ trans('global.edit') }}
                                        </a>
                                    @endcan

                                    @can('maintenance_event_delete')
                                        <form action="{{ route('admin.maintenance-events.destroy', $maintenanceEvent->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
